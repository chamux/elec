...
#include "poireau.dat" //diiiiiiiiiirty
...
void play_score(Note const * score)
{
	...
	while(score[i].pitch)
	{
		...
		bip_stop();
		wait_change_count(score[1].value);
		wait();
...
Note const fur_elise[]={{0,VIVACE},
			{STACCATO,0},
			{SIL,BLANCHE},{MI8,CROCHE},{REd8,CROCHE},
			...
			{SI,NOIRE},{SIL,CROCHE},{MI,CROCHE},{MI8,CROCHE},{MI,CROCHE},
			{MI8,CROCHE},{MI8,CROCHE},{MI16,CROCHE},{REd8,CROCHE},{MI8,CROCHE},{REd8,CROCHE},
			{MI8,CROCHE},{REd8,CROCHE},{MI8,CROCHE},{REd8,CROCHE},{MI8,CROCHE},{REd8,CROCHE},
			{MI8,CROCHE},{REd8,CROCHE},{MI8,CROCHE},{SI,CROCHE},{RE8,CROCHE},{DO8,CROCHE},
			{LA,NOIRE},{SIL,CROCHE},{DO,CROCHE},{MI,CROCHE},{LA,CROCHE},
			{SI,NOIRE},{SIL,CROCHE},{MI,CROCHE},{SOLd,CROCHE},{SI,CROCHE},
			{DO8,NOIRE},{SIL,CROCHE},{MI,CROCHE},{MI8,CROCHE},{REd8,CROCHE},
